...
export function Hud() {
  ...
  return (
    <div className="hud" style={{ ['--accent' as string]: colour }}>
      ...
      {/* Conversation log — positioned above live caption and command dock */}
      ...
      <AnimatePresence>
        {caption && (
          ...
          >
            <span className="caption-mic-dot" />
            <span className="caption-text">{caption}</span>
          </motion.div>
        )}
      </AnimatePresence>

      {/* The one surface for blades and panels */}
      <Blades />

      {ui.chrome.suggestions && <Suggestions />}

      <footer className="hud-bottom">
        <form className="hud-cmd-bar" onSubmit={handleCommandSubmit}>
