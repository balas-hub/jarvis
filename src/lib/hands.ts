...
/**
 * The model weights are loaded locally from public/mediapipe/hand_landmarker.task
 * for instantaneous initialization with zero network lag or CORS restrictions.
 */
